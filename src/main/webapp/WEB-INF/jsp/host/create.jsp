...
<div dojoType="dijit.TitlePane" style="width: 100%" title="Create New Host">
<c:url value="/host" var="form_url"/>
<form:form action="${form_url}" method="POST" modelAttribute="host">
<div id="roo_host_lab">
